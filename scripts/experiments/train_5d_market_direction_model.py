...
for path in [ROOT / "scripts", ROOT / "scripts" / "experiments"]:
...
DEFAULT_BASE_CSV = DEFAULT_OUTPUT_DIR / "00_A股日K.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--base-csv", default=str(DEFAULT_BASE_CSV), help="A股日K基础表")
